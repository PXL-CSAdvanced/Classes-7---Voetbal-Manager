...
1. Team:
	- Definieer een klasse "Team" met de volgende eigenschappen en variabelen:
		...
		- Een lijst met players die bij het team horen van het type Footballer. Zorg er voor dat deze lijst readonly is. Achterliggend heb je een variabelen die je aanpast met de methodes AddPlayer en RemovePlayer.
	...
	- Implementeer de volgende methodes:
		- Implementeer een methode, AddPlayer(Player player, bool isCaptain), om players aan het team toe te voegen. Indien de player een Captain is, dan wordt de huidige Captain waarde overschreven met de doorgegeven player.
		- Implementeer een methode, RemovePlayer(Player player), om players uit het team te verwijderen
		- Implementeer de methode ToString(), die de naam van het team teruggeeft.
		- Implementeer de methode AverageNumberOfGoals die de gemiddelde hoeveelheid doelpunten berekent voor alle players in het team.
...
2. Footballer:
	- Definieer een klasse "Player" met de volgende eigenschappen en variabelen:
		- FirstName: string
		- LastName: string
	...
	- Implementeer de volgende methodes:
		- Implementeer de ToString methode om de playernaam weer te geven. Deze geeft het volgende formaat “LastName - FirstName”.
...
<img src= "images/4.png" style="border: 2px solid grey;"/>
...
2. Playerbeheer:
	- Als gebruiker kan ik een team selecteren in de team-dropdown en vervolgens verschijnen alle players in de ListBox en toont de applicatie de informatie van het team en de eerste player.
	- Als gebruiker kan ik teams toevoegen aan het geselecteerde team.
	- Als gebruiker kan ik geselecteerde players verwijderen van een team.
3. User Interface:
	- Als gebruiker kan ik een selectie aanpassen in de dropdown of combobox om automatisch de layout te updaten.
	- Als gebruiker wordt ik gewaarschuwd wanneer ik ongeldige informatie gebruik voor een team of player toe te voegen.
4. Start situatie:
	- Wanneer de applicatie start, dan is er één team aanwezig. In dit team zijn minstens vier players aanwezig.